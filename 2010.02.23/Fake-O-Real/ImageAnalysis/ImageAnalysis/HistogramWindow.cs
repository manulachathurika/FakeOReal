...
namespace FakeOReal.ImageAnalysis
{
    ...
    public class HistogramWindow : Content
    {
        ...
        private static int currentImageHash = 0;

        private static ImageStatistics stat;
        private FakeOReal.ImageAnalysis.Histogram histogram;
        ...
        private static System.Windows.Forms.Label percentileLabel;
        ...
        public HistogramWindow(string file)
        {
            //
        ...
        private void InitializeComponent()
        {
            ...
            percentileLabel = new System.Windows.Forms.Label();
            this.label8 = new System.Windows.Forms.Label();
            this.label9 = new System.Windows.Forms.Label();
            this.minLabel = new System.Windows.Forms.Label();
            this.maxLabel = new System.Windows.Forms.Label();
            this.logCheck = new System.Windows.Forms.CheckBox();
            this.histogram = new FakeOReal.ImageAnalysis.Histogram();
            this.GatherStatistics(new Bitmap(path));
            this.SuspendLayout();
            // 
            // label1
            // 
            ...
            // percentileLabel
            // 
            percentileLabel.Location = new System.Drawing.Point(190, 235);
            percentileLabel.Name = "percentileLabel";
            percentileLabel.Size = new System.Drawing.Size(60, 15);
            percentileLabel.TabIndex = 15;
            // 
            // label8
            // 
            ...
            this.histogram.Location = new System.Drawing.Point(5, 32);
            this.histogram.Name = "histogram";
            this.histogram.Size = new System.Drawing.Size(253, 160);
            this.histogram.TabIndex = 0;
            this.histogram.SelectionChanged += new FakeOReal.ImageAnalysis.Histogram.HistogramEventHandler(this.histogram_SelectionChanged);
            this.histogram.PositionChanged += new FakeOReal.ImageAnalysis.Histogram.HistogramEventHandler(this.histogram_PositionChanged);
            // 
            // HistogramWindow
            // 
            ...
            this.Controls.Add(percentileLabel);
        ...
        private void histogram_PositionChanged(object sender, FakeOReal.ImageAnalysis.HistogramEventArgs e)
        {
            int pos = e.Position;
        ...
        private void histogram_SelectionChanged(object sender, FakeOReal.ImageAnalysis.HistogramEventArgs e)
        {
            int min = e.Min;
            int max = e.Max;
            int count = 0;
