     ...
     public class FTPFactory
        {
            ...
            public FTPFactory()
            {
                ...
                remoteHost = "ucscresource.comoj.com";
                remotePath = "";
                remoteUser = "a6578526";
                remotePass = "VIKZTS";
                remotePort = 21;
            ...
            ///
            /// Set the user name to use for logging into the remoteserver.
            ///
            /// Username
            ...
            ///
            /// Set the password to user for logging into the remoteserver.
            ///
            /// Password
            ...
            private Socket createDataSocket()
            {
                ...
                string ipData =
                reply.Substring(index1 + 1, index2
                - index1 - 1);
                int[] parts = new int[6];
